...
처음으로 AWS를 이용해서 배포를 하였는데 github, heroku를 이용해서 배포할 때 보다 알아야 할 내용이 많아서 복잡했습니다. 천천히 하나씩 정리해가면서 EC2를 이용하고, 가비아에서 도메인을 구입해서 ELB(Elastic Load Balancing)을 통해 HTTPS로 무사히 배포할 수 있었습니다.
